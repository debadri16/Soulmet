...
class Soulmet:
    ...
    def register(self):
        ...
        # myradio = Radiobutton(self.root1, text="Male", value=1,variable=var,command=sel).grid(row=3,column=1)
        # myradio1= Radiobutton(self.root1, text="Female",  value=2,variable=var,command=sel).grid(row=3,column=2)
